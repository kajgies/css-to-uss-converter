  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-10 p-24">
      <div className="prose z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex flex-col gap-10">
          ...
          <div className="flex flex-row w-full items-stretch justify-center gap-5">
          <div className='w-full'>
          <h2>Input Css</h2>
          <textarea className="textarea w-full h-[500px] textarea-bordered " defaultValue=".text-center { text-align: center; }" onChange={e => setCss(e.target.value)}></textarea>
          </div>
          <div className='flex flex-col justify-between grow items-center h-[500px]'>
            <div></div>
